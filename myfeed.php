...
$stmt = $pdo->prepare("SELECT rp_Animals.petname, rp_Animals.type, rp_Animals.description, rp_Animals.pathToPic, holdingID, beginningDate, endDate, pay, activities, extraInformation, complete from rp_Holdings inner join rp_Animals on rp_Animals.ID = rp_Holdings.animalID WHERE ownerid='$currentUser' order by beginningDate DESC");
if (false === $stmt) {
